...
<div class="nav">
    <ul>
      ...
      <li><a href="Event.php">Hostels & Services</a></li>
...
<div class="popup" id="popup">
   ...
   <div class="form">
     ...
     <div class="form-element">
       <label for="acn">Aadhar Card Number</label>
       <input type="text" id="acn" name="acn" required placeholder="Enter Your Aadhar Card Number" pattern="[0-9]{12}" title="Please enter a valid Aadhaar card number (12 digits)">
     </div>
     <div class="form-element">
       <label for="pan">Pan Card Number</label>
       <input type="text" id="pan" name="pan" required placeholder="Enter Your Pan Card Number"pattern="[A-Z]{5}[0-9]{4}[A-Z]{1}" title="Please enter a valid PAN card number">
     </div>
     <div class="form-element">
